    ...
    <div class="col-md-6">
        ...
        <form class="form-horizontal" method="post" action="{{ route('admin.news.list.store') }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="" required class="form-control" name="title" id="title" placeholder="输入新闻标题">
                </div>
            </div>
            <div class="form-group">
                <label for="sub_title" class="col-sm-2 control-label">副标题</label>
                <div class="col-sm-10">
                    <input type="text" value="" class="form-control" name="sub_title" id="sub_title" placeholder="输入新闻副标题">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" value="" class="form-control" name="author" id="author" placeholder="输入新闻作者">
                </div>
            </div>
            <div class="form-group">
                <label for="views_count" class="col-sm-2 control-label">浏览量</label>
                <div class="col-sm-10">
                    <input type="number" value="0" min="0" class="form-control" name="views_count" id="views_count" placeholder="输入浏览量">

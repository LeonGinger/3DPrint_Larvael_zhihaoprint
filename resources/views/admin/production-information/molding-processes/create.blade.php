<div class="row">
    <div class="col-md-6">
        ...
        <form class="form-horizontal" method="post" action="{{ route('admin.molding_processes.store') }}">
            {{ csrf_field() }}
            <div class="form-group">
                <label for="name" class="col-sm-2 control-label">工艺名称</label>
                <div class="col-sm-10">
                    <input type="text" value="" class="form-control" name="name" id="name" placeholder="输入工艺名称">
                </div>
            </div>
            <div class="form-group">
